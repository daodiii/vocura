...
import { Mic, ArrowLeft, BookOpen } from "lucide-react";

export const metadata = {
  title: "Dokumentasjon | Vocura AI",
  description: "Dokumentasjon for Vocura AI-plattformen.",
};
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-12">
          ...
          <p className="text-[#8B8B8B]">
            Dokumentasjon for Vocura AI-plattformen.
          </p>
        </div>

        <div className="bg-[#191919] border border-[rgba(255,255,255,0.06)] rounded-xl shadow-lg p-8 text-center">
          <BookOpen className="w-12 h-12 text-[#5E6AD2] mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-[#EDEDED] mb-2">
            Kommer snart
          </h2>
          <p className="text-[#8B8B8B] max-w-md mx-auto">
            Vi jobber med å ferdigstille dokumentasjonen. I mellomtiden kan du kontakte oss på{" "}
            <a href="mailto:hei@vocura.no" className="text-[#7B89DB] cursor-pointer">hei@vocura.no</a>{" "}
            for spørsmål.
          </p>
        </div>
