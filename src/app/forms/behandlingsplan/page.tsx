        ...
        <div className="min-h-screen bg-[var(--surface-deep)]">
            ...
            <main className="max-w-4xl mx-auto px-6 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-[var(--text-secondary)] mt-1">Strukturert behandlingsplan med mål, tiltak og oppfølgingsplan</p>
                </div>
                ...
                {submitted ? (
                    <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-12 text-center">
                        ...
                        <p className="text-[var(--text-secondary)] mb-6">Behandlingsplanen er lagret i pasientjournalen.</p>
                        {error && <p className="text-sm text-[#EF4444] mb-4">{error}</p>}
                        <p className="text-sm font-mono text-[var(--text-muted)] mb-8">Referanse: BEH-{Math.random().toString(36).substr(2, 8).toUpperCase()}</p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            ...
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Informasjon om pasienten</p>
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Fødselsnummer (11 siffer) <span className="text-[#EF4444]">*</span></label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Telefon</label>
                                    <input
                                        type="tel"
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">2. Diagnoseinformasjon</h2>
                            </div>
                            ...
                            <div>
                                <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Utdypende beskrivelse</label>
                                <textarea
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">3. Behandlingsmål</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Definerte mål for behandlingen</p>

                            <div className="space-y-4">
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Kortsiktige mål (4-6 uker) <span className="text-[#EF4444]">*</span></label>
                                    <textarea
                                ...
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Langsiktige mål (3-6 måneder) <span className="text-[#EF4444]">*</span></label>
                                    <textarea
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">4. Planlagte tiltak</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Intervensjoner og behandlingstiltak</p>
                            ...
                            {tiltak.length === 0 ? (
                                ...
                                <div className="space-y-3">
                                    {tiltak.map((t, index) => (
                                        <div key={t.id} className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-4 mb-3 relative">
                                            <button
                                                onClick={() => removeTiltak(t.id)}
                                                className="absolute top-3 right-3 p-1.5 rounded-lg text-[var(--text-muted)] hover:text-[#EF4444] hover:bg-[rgba(239,68,68,0.1)] transition-colors"
                                                title="Fjern tiltak"
                                            >
                                                <Trash2 className="w-4 h-4" />
                                            </button>

                                            <p className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider mb-3">Tiltak {index + 1}</p>

                                            <div className="grid grid-cols-2 gap-4 mb-3">
                                                <div>
                                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Navn på tiltak</label>
                                                    <input
                                                        type="text"
                                                        value={t.navn}
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mb-3">
                                                <div>
                                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Ansvarlig behandler</label>
                                                    <input
                                                        type="text"
                                                        value={t.ansvarlig}
                                                ...
                                                <div>
                                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Startdato</label>
                                                    <input
                                                        type="date"
                                                        value={t.startDato}
                                            ...
                                            <div>
                                                <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Beskrivelse</label>
                                                <textarea
                                                    value={t.beskrivelse}
                            ...
                            <button
                                onClick={addTiltak}
                                className="mt-3 w-full py-2.5 rounded-lg border-2 border-dashed border-[rgba(255,255,255,0.06)] text-sm font-medium text-[var(--text-secondary)] hover:border-[#5E6AD2] hover:text-[#7B89DB] hover:bg-[rgba(94,106,210,0.08)] transition-all flex items-center justify-center gap-2"
                            >
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">5. Medikamentplan</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Oversikt over medikamentell behandling</p>
                            ...
                            {medikamenter.length === 0 ? (
                                ...
                                <div className="space-y-3">
                                    {medikamenter.map((m, index) => (
                                        <div key={m.id} className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-4 mb-3 relative">
                                            <button
                                            ...
                                            <p className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider mb-3">Medikament {index + 1}</p>

                                            <div className="grid grid-cols-2 gap-4 mb-3">
                                                <div>
                                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Medikamentnavn</label>
                                                    <input
                                                        type="text"
                                                        value={m.navn}
                                                ...
                                                <div>
                                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Dosering</label>
                                                    <input
                                                        type="text"
                                                        value={m.dose}
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mb-3">
                                                ...
                                                <div>
                                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Varighet</label>
                                                    <input
                                                        type="text"
                                                        value={m.varighet}
                                            ...
                                            <div>
                                                <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Spesielle instruksjoner</label>
                                                <textarea
                                                    value={m.notater}
                                                    onChange={(e) => updateMedikament(m.id, 'notater', e.target.value)}
                                                    className="bg-[var(--surface-hover)] border border-[rgba(255,255,255,0.06)] rounded-lg text-[var(--text-primary)] px-3 py-2 text-sm w-full focus:outline-none focus:border-[#5E6AD2] placeholder:text-[var(--text-muted)] min-h-[40px] resize-y"
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">6. Aktivitet og livsstil</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Anbefalinger for livsstilsendringer</p>

                            <div>
                                <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Livsstilsanbefalinger</label>
                                <textarea
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">7. Oppfølgingsplan</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Plan for videre oppfølging og evaluering</p>

                            <div className="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Neste konsultasjon <span className="text-[#EF4444]">*</span></label>
                                    <input
                                        type="date"
                            ...
                            <div>
                                <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Evalueringskriterier</label>
                                <textarea
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">8. Pasientmedvirkning</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Pasientens samtykke og signatur</p>
                            ...
                            <label className={cn(
                                ...
                                />
                                <div>
                                    <span className="text-sm font-semibold text-[var(--text-primary)] block">Pasientens samtykke</span>
