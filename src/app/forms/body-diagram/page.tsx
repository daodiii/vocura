            ...
            <div className="sticky top-14 z-40 bg-[var(--surface-primary)]/80 border-b border-[rgba(255,255,255,0.06)]">
                <div className="max-w-6xl mx-auto px-6 h-12 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <button onClick={handleSave} disabled={saving} className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[rgba(255,255,255,0.05)] rounded-lg px-3 py-1.5 transition-colors duration-150 text-xs flex items-center gap-1.5 cursor-pointer">
                        ...
                        <button onClick={handleExportPdf} className="border border-[rgba(255,255,255,0.06)] text-[var(--text-secondary)] hover:bg-[rgba(255,255,255,0.05)] rounded-lg px-4 py-2 transition-colors duration-150 text-xs flex items-center gap-1.5 cursor-pointer">
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            ...
                            <div className="flex items-center justify-center gap-2 mb-6">
                                <button
                                    ...
                                    className={cn("px-4 py-2 rounded-lg text-sm font-semibold transition-all cursor-pointer", activeSide === 'front' ? "bg-[#5E6AD2] text-white" : "bg-[rgba(255,255,255,0.03)] text-[var(--text-secondary)] hover:bg-[rgba(255,255,255,0.05)]")}
                                >
                                    Foran
                                </button>
                                <button
                                    onClick={() => setActiveSide('back')}
                                    className={cn("px-4 py-2 rounded-lg text-sm font-semibold transition-all cursor-pointer", activeSide === 'back' ? "bg-[#5E6AD2] text-white" : "bg-[rgba(255,255,255,0.03)] text-[var(--text-secondary)] hover:bg-[rgba(255,255,255,0.05)]")}
                                >
                                    Bak
                                </button>
                            </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {selectedZone && selectedZoneInfo && (
                            <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-5">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <label className="block text-xs font-medium text-[var(--text-secondary)] mb-1.5">Smerteintensitet (NPRS)</label>
                                        <div className="flex items-center gap-3">
                                            <input
                                                type="range"
                                                min="0"
                                    ...
                                    <div>
                                        <label className="block text-xs font-medium text-[var(--text-secondary)] mb-1.5">Smertetype</label>
                                        <select
                                    ...
                                    <div>
                                        <label className="block text-xs font-medium text-[var(--text-secondary)] mb-1.5">Notater</label>
                                        <textarea
                                            value={existingPoint?.notes ?? newNotes}
                                            onChange={(e) => setNewNotes(e.target.value)}
                                            className="w-full bg-[var(--surface-hover)] border border-[rgba(255,255,255,0.06)] rounded-lg text-[var(--text-primary)] focus:outline-none focus:border-[#5E6AD2] placeholder:text-[var(--text-muted)] text-sm px-3 py-2 min-h-[60px] resize-y"
                                    ...
                                    {painPoints.map((point) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className="text-[var(--text-muted)] hover:text-[#EF4444] transition-colors cursor-pointer"
                                            >
