...
export default function SOAPForm() {
    ...
    return (
        <div className="min-h-screen bg-[var(--surface-deep)]">
            ...
            {/* Action Bar */}
            <div className="sticky top-14 z-40 bg-[var(--surface-primary)]/80 border-b border-[rgba(255,255,255,0.06)] backdrop-blur-sm">
                <div className="max-w-4xl mx-auto px-6 h-12 flex items-center justify-between">
                    <Breadcrumbs items={[
                        { label: 'Hjem', href: '/dashboard' },
                        { label: 'Skjemaer', href: '/forms' },
                        { label: 'SOAP Journalnotat' },
                    ]} />
                    <div className="flex items-center gap-3">
                        ...
                        <button onClick={handleExport} className="border border-[rgba(255,255,255,0.06)] text-[var(--text-secondary)] hover:bg-[rgba(255,255,255,0.05)] rounded-lg px-4 py-2 transition-colors duration-150 text-xs !py-2 !px-4 flex items-center gap-1.5">
            ...
            <main className="max-w-4xl mx-auto px-6 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-[var(--text-secondary)] mt-1">Standardisert klinisk dokumentasjon</p>
                </div>
                ...
                {submitted ? (
                    <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-12 text-center">
                        ...
                        <p className="text-[var(--text-secondary)] mb-6">SOAP-notatet er lagret i pasientjournalen.</p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">1. Pasient og konsultasjon</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Pasientinformasjon og konsultasjonsdetaljer</p>
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Konsultasjonsdato og -tid <span className="text-[#EF4444]">*</span></label>
                                    <input
                                        type="datetime-local"
                                ...
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Konsultasjonstype <span className="text-[#EF4444]">*</span></label>
                                    <select
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">2. S -- Subjektivt</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Pasientens beskrivelse av plager og symptomer</p>

                            <div className="space-y-4">
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Hovedplage <span className="text-[#EF4444]">*</span></label>
                                    <textarea
                                ...
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Symptomhistorikk</label>
                                    <textarea
                                ...
                                <div className="p-4 bg-[rgba(245,158,11,0.1)] rounded-lg border border-[rgba(245,158,11,0.2)]">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Smertlokalisering</label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Smerteintensitet (0-10)</label>
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">3. O -- Objektivt</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Kliniske funn og malinger</p>
                            ...
                            <div className="p-4 bg-[rgba(94,106,210,0.08)] rounded-lg border border-[rgba(94,106,210,0.15)] mb-4">
                                ...
                                <div className="grid grid-cols-4 gap-3 mb-3">
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-xs font-medium block mb-1.5">Systolisk <span className="text-[var(--text-muted)] font-normal">mmHg</span></label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-xs font-medium block mb-1.5">Diastolisk <span className="text-[var(--text-muted)] font-normal">mmHg</span></label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-xs font-medium block mb-1.5">Puls <span className="text-[var(--text-muted)] font-normal">bpm</span></label>
                                        <input
                                            type="number"
                                            value={formData.puls}
                                    ...
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-xs font-medium block mb-1.5">Temperatur <span className="text-[var(--text-muted)] font-normal">&deg;C</span></label>
                                        <input
                                            type="number"
                                ...
                                <div className="grid grid-cols-4 gap-3">
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-xs font-medium block mb-1.5">Resp.frekvens <span className="text-[var(--text-muted)] font-normal">/min</span></label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-xs font-medium block mb-1.5">SpO2 <span className="text-[var(--text-muted)] font-normal">%</span></label>
                                        <input
                                            type="number"
                                            value={formData.spo2}
                                    ...
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-xs font-medium block mb-1.5">Vekt <span className="text-[var(--text-muted)] font-normal">kg</span></label>
                                        <input
                                            type="number"
                                            value={formData.vekt}
                                    ...
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-xs font-medium block mb-1.5">Hoyde <span className="text-[var(--text-muted)] font-normal">cm</span></label>
                                        <input
                                            type="number"
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Fysisk undersokelse</label>
                                    <textarea
                                ...
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Laboratorieresultater</label>
                                    <textarea
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">4. A -- Analyse/Vurdering</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Diagnostisk vurdering</p>

                            <div className="mb-4">
                                <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Kodesystem</label>
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-4">
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Diagnosekode <span className="text-[#EF4444]">*</span></label>
                                    <input
                                        type="text"
                                ...
                                <div className="col-span-2">
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Diagnosebeskrivelse <span className="text-[#EF4444]">*</span></label>
                                    <input
                                        type="text"
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                formData.hoveddiagnoseKode === item.code
                                                    ...
                                                    : "bg-[var(--surface-primary)] text-[var(--text-secondary)] border-[rgba(255,255,255,0.06)] hover:border-[#5E6AD2] hover:text-[#7B89DB]"
                                            )}
                                        >
                            ...
                            <div>
                                <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Differensialdiagnoser</label>
                                <textarea
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-sm font-semibold text-[var(--text-primary)]">5. P -- Plan</h2>
                            </div>
                            <p className="text-xs text-[var(--text-muted)] mb-4 ml-6">Behandlingsplan og oppfolging</p>

                            <div className="space-y-4">
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Behandlingsplan <span className="text-[#EF4444]">*</span></label>
                                    <textarea
                                ...
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Medikamenter</label>
                                    <textarea
                                ...
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Henvisning</label>
                                    <textarea
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Oppfolging</label>
                                        <textarea
                                    ...
                                    <div>
                                        <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Neste konsultasjon</label>
                                        <input
                                            type="date"
                        ...
                        <div className="bg-[var(--surface-elevated)] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <h2 className="text-sm font-semibold text-[var(--text-primary)] mb-4 pb-3 border-b border-[rgba(255,255,255,0.06)]">6. Sykmelder</h2>
                            <div className="grid grid-cols-3 gap-4">
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Legens navn</label>
                                    <input
                                        type="text"
                                        value={formData.legeNavn}
                                        className="bg-[var(--surface-hover)] border border-[rgba(255,255,255,0.06)] rounded-lg text-[var(--text-primary)] px-3 py-2 text-sm w-full focus:outline-none focus:border-[#5E6AD2] placeholder:text-[var(--text-muted)] bg-[var(--surface-primary)]"
                                        readOnly
                                    />
                                </div>
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">HPR-nummer</label>
                                    <input
                                        type="text"
                                        value={formData.legeHPR}
                                        className="bg-[var(--surface-hover)] border border-[rgba(255,255,255,0.06)] rounded-lg text-[var(--text-primary)] px-3 py-2 text-sm w-full focus:outline-none focus:border-[#5E6AD2] placeholder:text-[var(--text-muted)] bg-[var(--surface-primary)] font-mono"
                                        readOnly
                                    />
                                </div>
                                <div>
                                    <label className="text-[var(--text-secondary)] text-sm font-medium block mb-1.5">Adresse</label>
                                    <input
                                        type="text"
