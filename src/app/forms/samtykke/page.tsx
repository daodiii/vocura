...
export default function SamtykkeForm() {
    ...
    const [formData, setFormData] = useState({
        ...
        patientAdresse: '',
        behandler: '',
        behandlingssted: 'MediScribe Legesenter',
            ...
            <main className="max-w-3xl mx-auto px-6 py-8">
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="glass-badge glass-badge-success">Helsedirektoratet</span>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="form-section">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h2 className="form-section-title !mb-0 !pb-0 !border-0">Pasientopplysninger</h2>
                            </div>
                        ...
                        {/* Consent Items */}
                        <div className="form-section">
                            <h2 className="form-section-title">Samtykke</h2>
                            <p className="text-sm text-[var(--text-secondary)] mb-6">Pasienten samtykker til følgende (kryss av):</p>

                            <div className="space-y-4">
                                <label className={cn(
                                    "flex items-start gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all",
                                    formData.samtykkeTilBehandling ? "border-[var(--primary)] bg-[var(--primary-subtle)]" : "border-[var(--glass-border)] hover:border-[var(--primary)]/30"
                                )}>
                                    <input
                                        type="checkbox"
                                        checked={formData.samtykkeTilBehandling}
                                        onChange={(e) => updateField('samtykkeTilBehandling', e.target.checked)}
                                        className="mt-0.5 w-5 h-5 rounded border-[var(--glass-border)] text-[var(--primary)] focus:ring-[var(--primary)]"
                                    />
                                    <div>
                                        <span className="text-sm font-semibold text-[var(--text-primary)] block">Samtykke til undersøkelse og behandling <span className="text-[var(--error)]">*</span></span>
                                ...
                                <label className={cn(
                                    "flex items-start gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all",
                                    formData.samtykkeJournalføring ? "border-[var(--primary)] bg-[var(--primary-subtle)]" : "border-[var(--glass-border)] hover:border-[var(--primary)]/30"
                                )}>
                                    <input
                                        type="checkbox"
                                    ...
                                    />
                                    <div>
                                        <span className="text-sm font-semibold text-[var(--text-primary)] block">Samtykke til journalføring <span className="text-[var(--error)]">*</span></span>
                                ...
                                <label className={cn(
                                    "flex items-start gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all",
                                    formData.samtykkeDeling ? "border-[var(--primary)] bg-[var(--primary-subtle)]" : "border-[var(--glass-border)] hover:border-[var(--primary)]/30"
                                )}>
                                    <input
                                        type="checkbox"
                                ...
                                <label className={cn(
                                    "flex items-start gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all",
                                    formData.samtykkeLydopptak ? "border-[var(--primary)] bg-[var(--primary-subtle)]" : "border-[var(--glass-border)] hover:border-[var(--primary)]/30"
                                )}>
                                    <input
                                        type="checkbox"
                                    ...
                                    <div>
                                        <span className="text-sm font-semibold text-[var(--text-primary)] flex items-center gap-2">
                                            ...
                                            <Mic className="w-3.5 h-3.5 text-[var(--primary-light)]" />
                                        </span>
                                ...
                                <label className={cn(
                                    "flex items-start gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all",
                                    formData.samtykkeAI ? "border-[var(--primary)] bg-[var(--primary-subtle)]" : "border-[var(--glass-border)] hover:border-[var(--primary)]/30"
                                )}>
                                    <input
                                        type="checkbox"
                        ...
                        {/* Limitations */}
                        <div className="form-section">
                            <h2 className="form-section-title">Begrensninger (valgfritt)</h2>
                            <textarea
                        ...
                        {/* Signature */}
                        <div className="form-section">
                            <h2 className="form-section-title">Signatur</h2>
                            <div>
                        ...
                        {/* Error message */}
                        {error && (
                            <div className="p-3 bg-[var(--error-subtle)] border border-[var(--error)]/20 rounded-lg text-sm text-[var(--error)]">
                                {error}
                            </div>
                        )}
                        ...
                        <div className="flex items-center justify-between py-4">
                            ...
                            <button
                                ...
                                disabled={!allRequiredConsents || !signature || submitting}
                                className={cn(
                                    "!py-2.5 !px-6 text-sm flex items-center gap-2",
                                    allRequiredConsents && signature && !submitting ? "glass-btn-primary cursor-pointer" : "bg-[var(--glass-bg)] text-[var(--text-muted)] rounded-lg font-semibold cursor-not-allowed"
                                )}
                            >
