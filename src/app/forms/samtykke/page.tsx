        ...
        <div className="min-h-screen bg-[#0A0A0A]">
            ...
            <main className="max-w-3xl mx-auto px-6 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-[#8B8B8B] mt-1">I henhold til Pasient- og brukerrettighetsloven og GDPR</p>
                </div>
                ...
                {signed ? (
                    <div className="bg-[#191919] border border-[rgba(255,255,255,0.06)] rounded-xl shadow-lg p-12 text-center">
                        ...
                        <p className="text-[#8B8B8B] mb-6">Pasientens samtykke er registrert og lagret i journalen.</p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-[#191919] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h2 className="text-sm font-semibold text-[#EDEDED]">Pasientopplysninger</h2>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="text-[#8B8B8B] text-sm font-medium block mb-1.5">Fødselsnummer <span className="text-[#EF4444]">*</span></label>
                                    <input
                                        type="text"
                        ...
                        {/* Consent Items */}
                        <div className="bg-[#191919] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <h2 className="text-sm font-semibold text-[#EDEDED] mb-3 pb-3 border-b border-[rgba(255,255,255,0.06)]">Samtykke</h2>
                            <p className="text-sm text-[#8B8B8B] mb-6">Pasienten samtykker til følgende (kryss av):</p>
                            ...
                            <div className="space-y-4">
                                <label className={cn(
                                    ...
                                    />
                                    <div>
                                        <span className="text-sm font-semibold text-[#EDEDED] block">Samtykke til undersøkelse og behandling <span className="text-[#EF4444]">*</span></span>
                                        <span className="text-xs text-[#8B8B8B] mt-1 block">Jeg samtykker til at helsepersonell kan utføre nødvendig undersøkelse og behandling i henhold til helsepersonelloven.</span>
                                    </div>
                                </label>
                                ...
                                <label className={cn(
                                    ...
                                    />
                                    <div>
                                        <span className="text-sm font-semibold text-[#EDEDED] block">Samtykke til journalføring <span className="text-[#EF4444]">*</span></span>
                                        <span className="text-xs text-[#8B8B8B] mt-1 block">Jeg samtykker til at opplysninger fra konsultasjonen registreres i min pasientjournal i tråd med GDPR og journalforskriften.</span>
                                    </div>
                                </label>
                                ...
                                <label className={cn(
                                    ...
                                    />
                                    <div>
                                        <span className="text-sm font-semibold text-[#EDEDED] block">Deling av helseopplysninger</span>
                                        <span className="text-xs text-[#8B8B8B] mt-1 block">Jeg samtykker til at relevante helseopplysninger kan deles med andre behandlere involvert i min behandling (f.eks. spesialister, laboratorier).</span>
                                    </div>
                                </label>
                                ...
                                <label className={cn(
                                    ...
                                    />
                                    <div>
                                        <span className="text-sm font-semibold text-[#EDEDED] flex items-center gap-2">
                                            Lydopptak av konsultasjonen
                                            <Mic className="w-3.5 h-3.5 text-[#7B89DB]" />
                                        </span>
                                        <span className="text-xs text-[#8B8B8B] mt-1 block">Jeg samtykker til at konsultasjonen kan tas opp som lydopptak for transkripsjons- og dokumentasjonsformål. Opptaket behandles i henhold til GDPR.</span>
                                    </div>
                                </label>
                                ...
                                <label className={cn(
                                    ...
                                    />
                                    <div>
                                        <span className="text-sm font-semibold text-[#EDEDED] block">AI-assistert dokumentasjon</span>
                                        <span className="text-xs text-[#8B8B8B] mt-1 block">Jeg samtykker til at AI-teknologi brukes for å transkribere og strukturere journalnotater. Alle AI-genererte tekster gjennomgås og godkjennes av behandler.</span>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        {/* Limitations */}
                        <div className="bg-[#191919] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <h2 className="text-sm font-semibold text-[#EDEDED] mb-3 pb-3 border-b border-[rgba(255,255,255,0.06)]">Begrensninger (valgfritt)</h2>
                            <textarea
                        ...
                        <div className="bg-[rgba(94,106,210,0.08)] border border-[rgba(94,106,210,0.15)] rounded-lg p-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-[#EDEDED] mb-1">Pasientens rettigheter</p>
                        ...
                        {/* Signature */}
                        <div className="bg-[#191919] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
                            <h2 className="text-sm font-semibold text-[#EDEDED] mb-3 pb-3 border-b border-[rgba(255,255,255,0.06)]">Signatur</h2>
                            <div>
                                ...
                                <input
                                    ...
                                    className="bg-[#222222] border border-[rgba(255,255,255,0.06)] rounded-lg text-[#EDEDED] px-3 py-2 text-sm w-full focus:outline-none focus:border-[#5E6AD2] placeholder:text-[#5C5C5C] italic"
                        ...
                        <div className="flex items-center justify-between py-4">
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    allRequiredConsents && signature && !submitting ? "bg-[#5E6AD2] hover:bg-[#4F5ABF] text-white cursor-pointer" : "bg-[rgba(255,255,255,0.03)] text-[#5C5C5C] cursor-not-allowed"
                                )}
                            >
